<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lvyouxianlulist.aspx.cs" Inherits="lvyouxianlulist" %>
                ...
                <td height="785" valign="top"><table id="Table13" width="758" height="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="758" height="42" background="qtimages/1_02_02_02_01.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="5%">&nbsp;</td>
                        <td width="95%" class="STYLE2"><strong>旅游线路</strong></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                                  ...
                                  <tbody>
                                      <tr class="tr1">
                                          <td style="padding-left: 5px; height: 25px">
                                              &nbsp; 编号：<asp:TextBox ID="bianhao" runat="server"></asp:TextBox>
                                              名称：<asp:TextBox ID="mingcheng" runat="server"></asp:TextBox>
                                              交通工具：<asp:DropDownList ID="jiaotonggongju" runat="server">
                                              </asp:DropDownList><span style="color: #000000"> &nbsp;</span><asp:Button ID="Button1"
                                                  runat="server" OnClick="Button1_Click" Text="查找" />
                                              <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AllowSorting="True"
                                                  ...
                                                  <Columns>
                                                      ...
                                                      <asp:BoundColumn DataField="shijian" HeaderText='时间'></asp:BoundColumn>
