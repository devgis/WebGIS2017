<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shangpinxinxilist.aspx.cs" Inherits="shangpinxinxilist" %>
                                                      ...
                                                      <asp:TemplateColumn HeaderText="图片">
                                                          <ItemTemplate>
                                                              <a href='<%#DataBinder.Eval(Container.DataItem, "tupian") %>' target='_blank'>
                                                                  <img border='0' height='99' src='<%#DataBinder.Eval(Container.DataItem, "tupian") %>'
                                                                      width='88' /></a></ItemTemplate>
                                                      </asp:TemplateColumn>
                                                      <asp:BoundColumn DataField="kucun" HeaderText='库存'></asp:BoundColumn>
                                                      <asp:BoundColumn DataField="faburen" HeaderText='发布人'></asp:BoundColumn>
                                                      <asp:TemplateColumn HeaderText="详细">
                                                <ItemTemplate>
                                                    <a href='shangpinxinxi_detail.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>'>
                                                        详细</a>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                                  </Columns>
