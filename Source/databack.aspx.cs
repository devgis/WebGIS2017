...
public partial class databack : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string myExecuteQuery = "backup database netlvxingshexns to disk='C:/netlvxingshexns.dat'";
        SqlCommand myCommand = new SqlCommand(myExecuteQuery, myConnection);
        myCommand.Connection.Open();
        myCommand.ExecuteNonQuery();
        myConnection.Close();
        Response.Write("<script>javascript:alert('数据成功备份于C:/netlvxingshexns.dat');location.href='sy.aspx';</script>");
        Response.End();
    }
}
