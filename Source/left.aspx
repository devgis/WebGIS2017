    ...
    <td align="center" valign="top" bgcolor="D4ECFC">
      <table width="162" height="100%" cellpadding="0" cellspacing="0">
        ...
        <tr id="td1" onClick="show(1)">
          <td height="25" background="images/list_task.jpg"> <span class="style1">员工用户管理</span></td>
        </tr>
        <tr id="show1">
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="edituser.aspx" target="hsgmain">员工用户添加</a></span></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="listuser.aspx" target="hsgmain">员工用户查看</a></span></td>
                    </tr>
                  </table></td>
                </tr>
        </table></td>
        ...
        <tr id="Tr5" onClick="show(6)">
          <td height="25" background="images/list_task.jpg"> <span class="style1">注册客户管理</span></td>
        </tr>
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="dd_list2.aspx" target="hsgmain">财务订单管理</a></span></td>
                    </tr>
                  </table></td>
                </tr>
        </table></td>
        ...
        <tr id="show9" style="display:none">
          ...
          <tr id="Tr10" onClick="show(10)">
          <td height="25" background="images/list_task.jpg"> <span class="style1">旅游线路管理</span></td>
        </tr>
        <tr id="show10" style="display:none">
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="lvyouxianlu_add.aspx" target="hsgmain">旅游线路添加</a></span></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="lvyouxianlu_list.aspx" target="hsgmain">旅游线路管理</a></span></td>
                    </tr>
                  </table></td>
                </tr>
